...
func Migrate() (*sql.DB, error) {
	...
	sqlStmt := `CREATE TABLE rekap (
		no_bon varchar(5) PRIMARY KEY,
		discount INTEGER,
		total INTEGER,
		bayar INTEGER,
		kembalian INTEGER,
		kode_kasir varchar(3),
		tanggal varchar(10),
		waktu varchar(8)
	) ` // TODO: replace this
	...
	_, err = db.Exec(`INSERT INTO rekap VALUES ("00001", 0, 77000, 100000, 23000, "K01", "04-05-2022", "12:00:00"),
	...
	_, err = db.Exec(`INSERT INTO rekap_detail VALUES ("00001", "B001", 4500, 3),
	("00001", "B002", 22500, 1),
	("00001", "B003", 1500, 4),
	("00001", "B004", 17500, 2),
	("00002", "B001", 4500, 1),
	...
	sqlStmt = `CREATE TABLE kasir (
		kode_kasir varchar(3) PRIMARY KEY,
		nama_kasir varchar(256)
	) ` // TODO: replace this
	...
	_, err = db.Exec(`INSERT INTO kasir VALUES ("K01", "Rosi"),
...
func checkBarangExists(kodeBarang string) (bool, error) {
	...
	sqlStmt := `SELECT CAST(substr(kode_barang,2) AS INTEGER) FROM barang WHERE kode_barang = ?` // TODO: replace this
...
func checkKasirExists(kodeKasir string) (bool, error) {
	...
	sqlStmt := `SELECT CAST(substr(kode_kasir,2) AS INTEGER) FROM kasir WHERE kode_kasir = ?` // TODO: replace this
