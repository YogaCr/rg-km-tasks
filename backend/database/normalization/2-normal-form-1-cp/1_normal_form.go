...
func Migrate() (*sql.DB, error) {
	...
	sqlStmt := `CREATE TABLE rekap (no_bon varchar(5), 
	...
	kasir varchar(256),
	tanggal varchar(10),
	waktu varchar(8)) ;` // TODO: replace this
	...
	_, err = db.Exec(`INSERT INTO rekap VALUES ("00001", "Disket", 4500, 3, 13500, 13500, 0, 13500, 100000, 23000, "Rosi", "04-05-2022", "12:00:00"),
